...
const videoEntry = {
  ...
  args: [
    ...
    { name: 'stall-timeout', type: 'int', default: 600, required: false, help: 'Maximum seconds without response progress' },
    { name: 'state-file', type: 'str', required: false, help: 'Owned local generation checkpoint' },
    { name: 'request-id', type: 'str', required: false, help: 'Input fingerprint for the owned checkpoint' },
  ],
